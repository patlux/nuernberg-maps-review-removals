...
__ANALYTICS__
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .menu-word { display: flex; align-items: center; gap: 14px; color: var(--nav-text); font-size: 22px; font-weight: 700; text-transform: uppercase; }
    .hamburger { display: grid; gap: 6px; width: 44px; }
    .hamburger span { display: block; height: 5px; border-radius: 2px; background: var(--nav-text); }
    ...
    @media (max-width: 720px) {
      ...
      .menu-word { gap: 10px; font-size: 18px; }
      .hamburger { gap: 5px; width: 36px; }
